...
musicwindow = customtkinter.CTk()
musicwindow.title("Meow Music")
musicwindow.geometry("800x500")
musicwindow.resizable(False,False)
...
bg_label = tk.Label(musicwindow, image=bg_image)
bg_label.place(relwidth=1, relheight=1)

inner_frame_width = 730
inner_frame_height = 383
inner_frame = customtkinter.CTkFrame(musicwindow, width=inner_frame_width, height=inner_frame_height, corner_radius=5, fg_color="#EFE0BF")
inner_frame.place(relx=0.5, rely=0.6, anchor=CENTER)

# font and title
font1 = ('Georgia',51,'bold')
title_label = customtkinter.CTkLabel(musicwindow,font=font1,text='Meow Music',text_color='#EFE0BF',bg_color='#1E2647')
...
back_btn = Button(musicwindow, image=back_btn_img, borderwidth=0, bg="#EFE0BF", command=previous_song)
forward_btn = Button(musicwindow, image=foward_btn_img, borderwidth=0, bg="#EFE0BF", command=next_song)
play_btn = Button(musicwindow,text="PLAY",width=10,height=1,font=("Arial",8,"bold"),fg="white",bg="#1E2647", command=play_song)
pause_btn = Button(musicwindow, image=pause_btn_img, borderwidth=0, bg="#EFE0BF", command=lambda: pause(paused))
stop_btn = Button(musicwindow, image=stop_btn_img, borderwidth=0, bg="#EFE0BF", command=stop)
...
Button(musicwindow,text="Your Playlist",width=19,height=1,font=("Arial",8,"bold"),fg="white",bg="#506580",command=open_folder).place(x=460,y=190)

# Button Remove song button
Button(musicwindow,text="Remove Song",width=19,height=1,font=("Arial",8,"bold"),fg="white",bg="#506580",command = delete_song).place(x=610,y=190)

# playlist frame
music_frame = Frame(musicwindow,bd=2,relief=RIDGE)
music_frame.place(x=460,y=220,width=300,height=200)

# Create the label for the border
border_label = Label(musicwindow, bg="#EFE0BF", bd=2, relief="solid", width=50, height=5)
border_label.place(x=60, y=229)

# Create the label for the text "Now Playing..."
text_label = Label(musicwindow, text="Now Playing....", font=("Georgia", 8, "bold"), fg="black", bg="#EFE0BF")
text_label.place(x=64, y=235)

# song name label display after choosing song ("now playing")              
music=Label(musicwindow,text="",font=("Georgia",12,"bold"),fg="black",bg="#EFE0BF")
music.place(x=228,y=270,anchor="center")

# Text for +
text_label2 = Label(musicwindow, text="+", font=("arial", 15, "bold"), fg="black", bg="#EFE0BF")
text_label2.place(x=400, y=165)

# Text for -
text_label3 = Label(musicwindow, text="-", font=("arial", 18, "bold"), fg="black", bg="#EFE0BF")
text_label3.place(x=380, y=160)

# Text for "VOLUME"
text_label3 = Label(musicwindow, text="volume", font=("arial", 8, "bold"), fg="black", bg="#EFE0BF")
text_label3.place(x=218, y=169)

# Time Minute and Sec of the song
status_bar = Label(musicwindow, text='',font=("Courier new",8,"bold"),fg="black",bg="#EFE0BF")
...
my_slider = ttk.Scale(musicwindow, from_=0, to=100, orient=HORIZONTAL, value=0, command=slide, length=355, style="Music.Horizontal.TScale")
...
volume_slider = ttk.Scale(musicwindow, from_=0, to=1, orient=HORIZONTAL, value=1, command=volume, length=200, style="Volume.Horizontal.TScale")
