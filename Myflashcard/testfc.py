...
if __name__ == '__main__':
    ...
    style = ttkstyle(theme='superhero')
    ...
    create_set_frame = tk.Frame(notebook)
    ...
    # Button to add a word to the set () => for the next part
    ...
    select_set_frame = tk.Frame(notebook)
    ...
    definition_label = ttk.Label(flashcards_frame, text='', font=('TkDefaultFont', 16))
    ...
    populate_sets_combobox()  # corrected function call
    root.mainloop()
